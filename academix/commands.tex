...
% Custom command to format author information for the document and cataloging
\newcommand{\autorPoli}[5]{
    \customAutor{\uppercase{{#1 #4 #5}}}% Full name in uppercase (First Middle Last)
    \renewcommand{\PoliAutorFichaCatalografica}{{#5, #1 #3}}% Cataloging format
    \renewcommand{\PoliAutorIniciaisMaisSobrenome}{{#2 #4 #5}}% Initials + Last name format
}
